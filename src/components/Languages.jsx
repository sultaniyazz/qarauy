...
const Languages = () => {
    ...
    return (
        <div onMouseEnter={handleOnMouseEnter} onMouseLeave={handleOnMouseLeave} className={`${isHover ? "shadow-md" : ""} max-md:w-full relative`}>
            <button className={`${isHover ? "rounded-t-[.5vw] bg-white" : "rounded bg-gray-50"} duration-100 max-md:w-full  flex items-center text-[1.2vw] max-md:text-[4vw] max-md:px-[3vw] w-[11.5vw] py-[.2vw]  px-[1.2vw] gap-[.2vw]`}>
                <TbWorld />
